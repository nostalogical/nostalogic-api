...
VALUES ('21f16bbb-a9ca-4583-a6d2-bf6a5b811f5d', 'Equal priority opposite effect 1', 'ONE_AUTO') ON CONFLICT DO NOTHING;
...
INSERT INTO policy (id, name, priority)
VALUES ('93b8b29f-ad3f-4697-a716-1c56fe9d93d8', 'Equal priority opposite effect 2', 'ONE_AUTO') ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('f2adeff6-912d-4022-b5b4-267ecef4beee', 'Equal result for resource 1', 'ONE_AUTO') ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('c013563b-6480-43e4-bc1b-c457d389df95', 'Equal result for resource 2', 'ONE_AUTO') ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('35929e52-4f15-4f41-a445-e4e68ef3f30e', 'Multiple subjects report 1', 'ONE_AUTO') ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('1f88a5b8-55af-47a9-b43d-c22da8d1721a', 'Multiple subjects report 2', 'ONE_AUTO') ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
