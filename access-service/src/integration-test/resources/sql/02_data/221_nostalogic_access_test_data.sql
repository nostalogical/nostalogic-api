...
-- Test entity IDs:
-- b332223b-32bf-42b7-bb07-24174516a410
-- 465de7d6-5492-4d23-8228-6a29b0c101f4
-- d237431f-70db-4b7d-91dc-cfd0a0ca763e

-- Equal priority, opposite effect access to an article
INSERT INTO policy (id, name, priority)
VALUES ('21f16bbb-a9ca-4583-a6d2-bf6a5b811f5d', 'Equal priority opposite effect 1', 0) ON CONFLICT DO NOTHING;
...
INSERT INTO policy (id, name, priority)
VALUES ('93b8b29f-ad3f-4697-a716-1c56fe9d93d8', 'Equal priority opposite effect 2', 0) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('922119b2-1b5d-42dc-9208-0fd9d17aa5f1', 'High priority test 1', 1) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('53d2ed24-bec0-41f1-9609-1532b0849102', 'High priority test 2', 2) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('f2adeff6-912d-4022-b5b4-267ecef4beee', 'Equal result for resource 1', 0) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('c013563b-6480-43e4-bc1b-c457d389df95', 'Equal result for resource 2', 0) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('35929e52-4f15-4f41-a445-e4e68ef3f30e', 'Multiple subjects report 1', 0) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
...
INSERT INTO policy (id, name, priority)
VALUES ('1f88a5b8-55af-47a9-b43d-c22da8d1721a', 'Multiple subjects report 2', 0) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
