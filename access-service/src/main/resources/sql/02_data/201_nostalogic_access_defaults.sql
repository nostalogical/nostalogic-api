...
-- This policy hides server settings for any user below admin level
INSERT INTO policy (id, name, priority)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5', 'Default Settings Restrictions', 'THREE_HIGH') ON CONFLICT DO NOTHING;

INSERT INTO policy_action (id, policy_id, action, allow)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::READ', '4284074e-955c-4bde-bc78-0296f67d29a5', 'READ', false) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::CREATE', '4284074e-955c-4bde-bc78-0296f67d29a5', 'CREATE', false) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::CREATE', '4284074e-955c-4bde-bc78-0296f67d29a5', 'EDIT', false) ON CONFLICT DO NOTHING;
INSERT INTO policy_action (id, policy_id, action, allow)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::CREATE', '4284074e-955c-4bde-bc78-0296f67d29a5', 'DELETE', false) ON CONFLICT DO NOTHING;

INSERT INTO policy_resource (id, policy_id, resource_id, entity)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::GROUP', '4284074e-955c-4bde-bc78-0296f67d29a5', null, 'SETTING') ON CONFLICT DO NOTHING;

INSERT INTO policy_subject (id, policy_id, subject_id, entity)
VALUES ('4284074e-955c-4bde-bc78-0296f67d29a5::ALL', '4284074e-955c-4bde-bc78-0296f67d29a5', null, 'ALL') ON CONFLICT DO NOTHING;
