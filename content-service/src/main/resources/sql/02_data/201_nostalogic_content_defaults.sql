...
Firstly a separate Github account needs to be set up for this site to contain the data though, along with writing up the articles. ETA is 2020-03-01.', 'ACTIVE') ON CONFLICT DO NOTHING;
